                            ...
                            <div className="col-lg-7">
                                <div className="details-content">
                                    ...
                                    <div className="cart-quantity">
                                        ...
                                        <Link to="/shop-details" className="shop-btn theme-btn"><i className="fa-regular fa-bag-shopping"></i> Add to cart</Link>
                                    ...
                                    <div className="review-wrap-area d-flex gap-4">
                                        ...
                                        <div className="review-content">
                                            <div
                                                ...
                                                <div className="cont">
                                                    <h5><Link to="/news-details">Salman Ahmed</Link></h5>
