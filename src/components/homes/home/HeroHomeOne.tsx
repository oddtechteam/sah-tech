                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="hero-content">
                            <span className="wow fadeInUp">Welcome to Sahyadriworldschool</span>
                            <h1 className="wow fadeInUp" data-wow-delay=".3s">
                                Interactive Learning
                                Engaging Students in
                                the Digital Age
                            </h1>
                            <h3 className="wow fadeInUp" data-wow-delay=".5s">Get  2800+ Best Quality Online Courses From Sahyadriworldschool</h3>
