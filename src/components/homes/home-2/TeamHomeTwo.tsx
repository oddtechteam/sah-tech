                ...
                <div className="row">
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div className="team-box-items style-2">
                            ...
                            <div className="team-content">
                                <h4>
                                    <Link to="/instructor-details">EventName</Link>
                                </h4>
                               Details Of Event
                            </div>
                        </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div className="team-box-items style-2">
                            ...
                            <div className="team-content">
                                <h4>
                                    <Link to="/instructor-details">William J. Postma</Link>
                                </h4>
                               Details Of Event
                            </div>
                        </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div className="team-box-items style-2">
                            ...
                            <div className="team-content">
                                <h4>
                                    <Link to="/instructor-details">Matthew L. Orndorff</Link>
                                </h4>
                               Details Of Event
                            </div>
                        </div>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div className="team-box-items style-2">
                            ...
                            <div className="team-content">
                                <h4>
                                    <Link to="/instructor-details">Nicholas M. Davis</Link>
                                </h4>
                               Details Of Event
                            </div>
                        </div>
