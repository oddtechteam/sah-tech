                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="news-box-items-2">
                            ...
                            <div className="news-content">
                                ...
                                <h3>
                                    <Link to="/news-details">Importance Play-Based Learning in Early Childhood Education</Link>
                                </h3>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div className="news-box-items-2">
                            ...
                            <div className="news-content">
                                ...
                                <h3>
                                    <Link to="/news-details">Nurturing Creativity Activities to Boost Your Child’s Imagination</Link>
                                </h3>
                                <Link to="/news-details" className="theme-btn">Read More</Link>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div className="news-box-items-2">
                            ...
                            <div className="news-content">
                                ...
                                <h3>
                                    <Link to="/news-details">Building Social Skills The Role of Activities in Kindergarten</Link>
                                </h3>
                                <Link to="/news-details" className="theme-btn">Read More</Link>
                            </div>
                        </div>
