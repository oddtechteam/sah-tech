      ...
      <footer className="footer-section-5 fix">
           ...
           <div className="bg-shape-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1920" viewBox="0 0 1920 1008" fill="none">
                <path d="M1920 0.593408C1816.08 125.958 1643.2 189.417 1479.44 200.073C1315.97 210.351 1157.11 173.787 1003.24 133.837C849.373 93.8878 694.545 49.3077 532.313 43.4448C370.082 37.5818 128.293 78.9178 -0.207674 183.093L-0.206636 1008.59L1920 1008.59L1920 0.593408Z" fill="#004f7d"/>
              </svg>
            </div>
                    ...
                    <div className="cta-wrapper-5">
                        <div className="section-title text-center">
                            ...
                            <h2 className="text-white wow fadeInUp" data-wow-delay=".3s">
                                ...
                                Courses with Sahyadriworldschool
                            </h2>
                        </div>
                        <Link to="/contact" className="theme-btn mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".3s">Get Started Now</Link>
                    </div>
                </div>
            </div>
            <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-5 col-lg-5 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".4s">
                            <div className="single-footer-widget style-left">
                                <div className="widget-head">
                                   <h4>Ready to Get started your business <br /> Coach with Sahyadriworldschool</h4>
                                </div>
            ...
            <div className="footer-bottom style-3 style-5">
                <div className="container">
                    <div className="footer-bottom-wrapper">
                        <p className="wow fadeInUp" data-wow-delay=".3s">Copyright © <Link to="/">Sahyadriworldschool</Link>, all rights reserved.</p>
